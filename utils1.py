...
def multi_task_trainer(train_loader, test_loader, multi_task_model, device, optimizer, scheduler, opt, total_epoch=200):
    ...
    for index in range(total_epoch):
        ...
        writer.add_scalar("Semantic Loss training", avg_cost[index,0], index)
        writer.add_scalar("Semantic pixel accuracy training", avg_cost[index,2], index)
        writer.add_scalar("Depth Loss training", avg_cost[index,3], index)
        writer.add_scalar("Normal loss training", avg_cost[index,6], index)
        ...
        writer.add_scalar("Semantic Loss testing", avg_cost[index,12], index)
        writer.add_scalar("Semantic pixel accuracy testing", avg_cost[index,14], index)
        writer.add_scalar("Depth Loss testing", avg_cost[index,15], index)
        writer.add_scalar("Normal loss testing", avg_cost[index,18], index)
        ...
        if index%5==0:
            torch.save({
                ...
                'loss': loss,
                'scheduler':scheduler,
                }, f"C:/Users/usmehtja/Desktop/DL/weights/jashdeep{index}.pth")
