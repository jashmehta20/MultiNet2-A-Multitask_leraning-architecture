...
if opt.apply_augmentation:
    nyuv2_train_set = NYUv2(root=opt.dataroot, train=True, augmentation=True, small=750)

else:
    nyuv2_train_set = NYUv2(root=opt.dataroot, train=True, augmentation=False, small=500)
